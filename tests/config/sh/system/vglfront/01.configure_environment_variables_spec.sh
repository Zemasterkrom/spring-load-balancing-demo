        ...
        Context 'Success cases'
            ...
            Context 'Single variable'
                ...
                It "writes a single browser environment variable to a file using JavaScript notation : $1 = $2"
                    When call node ../FileEnvironmentConfigurator.js test.js utf-8 @JSKEY@ @JSVALUE@ "window['environment']['@JSKEY@'] = '@JSVALUE@';" "$1" "$2"
            ...
            Context 'Multiple variables'
                ...
                It "writes two browser environment variables to a file using JavaScript notation : $1 = $2 ; $3 = $4"
                    When call node ../FileEnvironmentConfigurator.js test.js utf-8 @JSKEY@ @JSVALUE@ "window['environment']['@JSKEY@'] = '@JSVALUE@';" "$1" "$2" "$3" "$4"
                    The status should be success
                    The stdout should be blank
                    The stderr should be blank
            ...
            Context 'Omitted value for a key'
                It "writes an empty value browser environment variable value to a file using JavaScript notation"
                    When call node ../FileEnvironmentConfigurator.js test.js utf-8 @JSKEY@ @JSVALUE@ "window['environment']['@JSKEY@'] = '@JSVALUE@';" key
                    The status should be success
                    The stdout should be blank
                    The stderr should be blank
                ...
                It "writes two browser environment variables and a empty variable value to a file using JavaScript notation"
                    When call node ../FileEnvironmentConfigurator.js test.js utf-8 @JSKEY@ @JSVALUE@ "window['environment']['@JSKEY@'] = '@JSVALUE@';" keyOne valueOne keyTwo
                    The status should be success
                    The stdout should be blank
                    The stderr should be blank
                    The lines of contents of file test.js should eq 2
        ...
        Context 'Error cases'
            Context 'Invalid number of arguments'
                It 'fails to configure a JavaScript environment file because no arguments have been passed to the script'
                    When call node ../FileEnvironmentConfigurator.js
                    The status should eq 2
                    The stdout should be blank
                    The stderr should eq "Usage: node FileEnvironmentConfigurator.js <Path to the environment file> <Environment file encoding> <Key placeholder> <Value placeholder> <Environment template> <First key> <First value> ..."
                ...
                It 'fails to configure a JavaScript environment file because there is only one argument instead of 6'
                    When call node ../FileEnvironmentConfigurator.js test.js
                    The status should eq 2
                    The stdout should be blank
                    The stderr should eq "Usage: node FileEnvironmentConfigurator.js <Path to the environment file> <Environment file encoding> <Key placeholder> <Value placeholder> <Environment template> <First key> <First value> ..."
                    The file test.js should not be exist
                ...
                It 'fails to configure a JavaScript environment file because there are only 2 arguments instead of 6'
                    When call node ../FileEnvironmentConfigurator.js test.js utf-8
                    The status should eq 2
                    The stdout should be blank
                    The stderr should eq "Usage: node FileEnvironmentConfigurator.js <Path to the environment file> <Environment file encoding> <Key placeholder> <Value placeholder> <Environment template> <First key> <First value> ..."
                    The file test.js should not be exist
                ...
                It 'fails to configure a JavaScript environment file because there are only 3 arguments instead of 6'
                    When call node ../FileEnvironmentConfigurator.js test.js utf-8 @JSKEY@
                    The status should eq 2
                    The stdout should be blank
                    The stderr should eq "Usage: node FileEnvironmentConfigurator.js <Path to the environment file> <Environment file encoding> <Key placeholder> <Value placeholder> <Environment template> <First key> <First value> ..."
                    The file test.js should not be exist
                ...
                It 'fails to configure a JavaScript environment file because there are only 4 arguments instead of 6'
                    When call node ../FileEnvironmentConfigurator.js test.js utf-8 @JSKEY@ @JSVALUE@
                    The status should eq 2
                    The stdout should be blank
                    The stderr should eq "Usage: node FileEnvironmentConfigurator.js <Path to the environment file> <Environment file encoding> <Key placeholder> <Value placeholder> <Environment template> <First key> <First value> ..."
                    The file test.js should not be exist
                ...
                It 'fails to configure a JavaScript environment file because there are only 5 arguments instead of 6'
                    When call node ../FileEnvironmentConfigurator.js test.js utf-8 @JSKEY@ @JSVALUE@ "window['environment']['@JSKEY@'] = '@JSVALUE@';"
                    The status should eq 2
                    The stdout should be blank
                    The stderr should eq "Usage: node FileEnvironmentConfigurator.js <Path to the environment file> <Environment file encoding> <Key placeholder> <Value placeholder> <Environment template> <First key> <First value> ..."
                    The file test.js should not be exist
            ...
            Context 'Invalid configuration'
                Parameters
                    "" utf-8 @JSKEY@ @JSVALUE@ "window['environment']['@JSKEY@'] = '@JSVALUE@';" key value "The environment file path can't be empty"
                    " " utf-8 @JSKEY@ @JSVALUE@ "window['environment']['@JSKEY@'] = '@JSVALUE@';" key value "The environment file path can't be empty"
                    test.js utf-8 "" @JSVALUE@ "window['environment']['@JSKEY@'] = '@JSVALUE@';" key value "The key placeholder can't be empty"
                    test.js utf-8 " " @JSVALUE@ "window['environment']['@JSKEY@'] = '@JSVALUE@';" key value "The key placeholder can't be empty"
                    test.js utf-8 @JSKEY@ "" "window['environment']['@JSKEY@'] = '@JSVALUE@';" key value "The value placeholder can't be empty"
                    test.js utf-8 @JSKEY@ " " "window['environment']['@JSKEY@'] = '@JSVALUE@';" key value "The value placeholder can't be empty"
                    test.js utf-8 @JSKEY@ @JSVALUE@ "" key value "The environment template can't be empty"
                    test.js utf-8 @JSKEY@ @JSVALUE@ " " key value "The environment template can't be empty"
                End

                It "fails to configure a JavaScript environment file because the configuration arguments are invalid : $1 $2 $3 $4 $5"
                    When call node ../FileEnvironmentConfigurator.js "$1" "$2" "$3" "$4" "$5" "$6" "$7"
                    The status should eq 2
                    The stdout should be blank
            ...
            Context 'Data errors'
                It 'fails to configure a JavaScript environment file because the environment variable key is empty'
                    When call node ../FileEnvironmentConfigurator.js test.js utf-8 @JSKEY@ @JSVALUE@ "window['environment']['@JSKEY@'] = '@JSVALUE@';" "" value
                    The status should eq 2
                    The stdout should be blank
                ...
                It 'fails to configure a JavaScript environment file because an environment variable key is empty'
                    When call node ../FileEnvironmentConfigurator.js test.js utf-8 @JSKEY@ @JSVALUE@ "window['environment']['@JSKEY@'] = '@JSVALUE@';" keyOne valueOne "" valueTwo
                    The status should eq 2
                    The stdout should be blank
